            ...
            <div className='fixed z-40 w-full bg-white'>
                <nav className="pt-1 pb-4 text-xs text-white bg-red-600 shadow-md lg:text-base">
                    <div className="flex flex-col items-center justify-between mx-auto max-w-7xl">
                        ...
                        {/*bottom section */}
                        <div className="hidden space-x-5 font-semibold md:flex ">

                          {/* logo */}
                           <Link to={'/SecondHomePage'}>
                            <img
                            ...
                            {/*home*/}
                            <Link to={"/SecondHomePage"} className="hover:text-gray-300 md:mt-1 lg:mt-0">Home</Link>
            
                            {/*about*/}
                            <div className="relative group">
                                <div className='flex flex-row hover:text-gray-300'>
                                    <button className="rounded-md ">Office-Bearers</button>
                                    <ChevronDown />
                                </div>
                                ...
                                <div className="absolute hidden w-40 text-black transition-opacity bg-white rounded-md shadow-lg group-hover:block -left-8">
                                    ...
                                    <Link to={'/current2'} className="block px-2 py-1 font-normal hover:bg-red-600 hover:text-white ">Current Bearers</Link>
                                    <Link to={'/previous2'} className="block px-2 py-1 font-normal hover:bg-red-600 hover:text-white">Previous Bearers</Link>
                                </div>
                            </div>
                            {/*rules & regulation*/}
                            <div className="relative group">
                                ...
                                <div className="absolute left-0 hidden w-40 text-black transition-opacity bg-white rounded-md shadow-lg group-hover:block ">
                                    ...
                                    <Link to={"/unionrule2"} className="block px-2 py-1 font-normal hover:bg-red-600 hover:text-white ">Rules in Hindi</Link>
                                    <Link to={"/memberrule2"} className="block px-2 py-1 font-normal hover:bg-red-600 hover:text-white">Rules in English</Link>
                                </div>
                            </div>
                            {/*member & benefit*/}
                            <div className="relative group">
                            ...
                            {/*contact*/}
                            <Link to={"/contactus2"} className="hover:text-gray-300 md:mt-1 lg:mt-0">Contact Us</Link>
                            <Link to={"/home"} className="hover:text-gray-300 md:mt-1 lg:mt-0">LogOut</Link>
                        </div>
                ...
                {isMobileMenuOpen && (
                    <div className="relative h-screen pt-16 space-y-20 text-center text-white bg-gray-800 md:hidden">
                        <div className="flex flex-col p-4 space-y-6">
                            <Link to={"/SecondHomePage"} className="hover:text-gray-300">Home</Link>
                            {/* about */}
                            ...
                            <Link to={"/contactus2"} className="hover:text-gray-300 ">Contact Us</Link>
                            <Link to={"/home"} className="hover:text-gray-300 ">LogOut</Link>
                        </div>
