...
const MedicalShow = () => {
  ...
  const fetchMembers = async () => {
    const resShow = await fetch(`${apiUrl}/medicals`, {
      'method': 'GET',
      'headers': {
  ...
  const deleteMember = async (id) => {
    ...
    const resShow = await fetch(`${apiUrl}/medicals/${id}`, {
      'method': 'DELETE',
      'headers': {
        'Content-type': 'application/json'
      }
          ...
          <div className="p-4">
            <div className="mx-auto max-w-7xl">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to={'/backend/websitechanges/medical/create'} > <button className="px-4 py-2 text-white bg-blue-500 rounded shadow-md hover:bg-blue-600">
                  ADD NEW
                </button></Link>
              </div>
